...
translate chinese_simplified strings:
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能不适用于所有游戏，并且某些选项组合可能会导致游戏无法玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与原来相同。"
    ...
    new "该程序包含许多许可证下的免费软件，包括 MIT 许可证和 GNU 宽通用公共许可证。可在{a=https://www.renpy.org/l/license}此处{/a}找到完整的软件列表，包括指向完整源代码的链接。"
    ...
    new "自我表达会说“[renpy.display.tts.last]\”。按“alt+shift+V”禁用。"
    ...
    new "这台计算机显示图形时出现问题：[问题]。"

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "它的图形驱动程序可能已过时或无法正常运行。这会导致图形显示缓慢或不正确。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} 文件可能包含帮助您确定计算机问题所在的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "有关如何解决此问题的更多详细信息，请参阅{a=[url]}文档{/a}。"
