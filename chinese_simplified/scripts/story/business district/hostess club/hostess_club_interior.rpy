...
# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:24
translate chinese_simplified hostess_club_interior_390c5c91:
    ...
    player "天哪，我终于来了！" id hostess_club_interior_390c5c91
...
translate chinese_simplified hostess_club_interior_f219ed97:
    ...
    player "这个俱乐部比我以前见过的任何人都好。" id hostess_club_interior_f219ed97
...
translate chinese_simplified hostess_club_interior_ae839375:
    ...
    # player "[yasuka.n] ne devrait pas etre loin!" id hostess_club_interior_ae839375
    player "应该在附近！" id hostess_club_interior_ae839375

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:29
translate chinese_simplified hostess_club_interior_b1bc8d50:

    # macumba "Hey petit frere!" id hostess_club_interior_b1bc8d50
    macumba "嘿，小兄弟！" id hostess_club_interior_b1bc8d50

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:30
translate chinese_simplified hostess_club_interior_10249b75:

    # player surprised "[macumba.n]?!" id hostess_club_interior_10249b75
    player surprised "[macumba.n]？！" id hostess_club_interior_10249b75

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:31
translate chinese_simplified hostess_club_interior_2b5459a8:

    # player happy "Je ne t'avais pas reconnu, ça te change vraiment le costard!" id hostess_club_interior_2b5459a8
    player happy "我没认出你来，这真的改变了你的衣服！" id hostess_club_interior_2b5459a8

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:32
translate chinese_simplified hostess_club_interior_d0464d1e:

    # macumba happy "Toi aussi!" id hostess_club_interior_d0464d1e
    macumba happy "你也是" id hostess_club_interior_d0464d1e

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:33
translate chinese_simplified hostess_club_interior_d013e49b:

    # player "...C'est vrai." id hostess_club_interior_d013e49b
    player "……是的。" id hostess_club_interior_d013e49b
...
translate chinese_simplified hostess_club_interior_44545f7a:
    ...
    player "我不知道你在这里工作，如果我知道的话，事情会更简单。" id hostess_club_interior_44545f7a
...
translate chinese_simplified hostess_club_interior_ffcb7302:
    ...
    # macumba sad "Tu as des problemes mon frere?" id hostess_club_interior_ffcb7302
    macumba sad "你有什么问题吗，兄弟？" id hostess_club_interior_ffcb7302

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:36
translate chinese_simplified hostess_club_interior_2b779620:
    ...
    player sad "一、…我不想让你难堪，我需要学会不要每次遇到麻烦都依赖你。" id hostess_club_interior_2b779620
...
translate chinese_simplified hostess_club_interior_b6d6c439:
    ...
    macumba neutral "想自己解决问题是值得尊敬的。" id hostess_club_interior_b6d6c439
...
translate chinese_simplified hostess_club_interior_d96a3cc5:
    ...
    macumba "但别忘了，你可以永远依靠我！" id hostess_club_interior_d96a3cc5
...
translate chinese_simplified hostess_club_interior_d6fafa5a:
    ...
    # macumba "Dis moi ce que je peux faire pour toi." id hostess_club_interior_d6fafa5a
    macumba "告诉我我能为你做什么。" id hostess_club_interior_d6fafa5a

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:40
translate chinese_simplified hostess_club_interior_b7629b45:
    ...
    player happy "你真的是我见过的最好的人。。。" id hostess_club_interior_b7629b45
...
translate chinese_simplified hostess_club_interior_c1f275b0:
    ...
    player "有一个人…在这里工作，我很关心！" id hostess_club_interior_c1f275b0
...
translate chinese_simplified hostess_club_interior_ca862fc3:
    ...
    player upset "我有太多人想给我惹麻烦，他们会毫不犹豫地通过她来找我。" id hostess_club_interior_ca862fc3
...
translate chinese_simplified hostess_club_interior_c56e8622:
    ...
    # macumba upset "Alors ce ne sont pas des hommes!" id hostess_club_interior_c56e8622
    macumba upset "所以他们不是男人！" id hostess_club_interior_c56e8622

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:44
translate chinese_simplified hostess_club_interior_870d7761:

    # macumba "Je crois avoir vu un banc un peu plus loin." id hostess_club_interior_870d7761
    macumba "我想我再往前看一点。" id hostess_club_interior_870d7761

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:45
translate chinese_simplified hostess_club_interior_d0e29d9f:

    # macumba "Cite moi un nom et je j'irais lui enfoncer dans son cul!" id hostess_club_interior_d0e29d9f
    macumba "给我一个名字，我就把它塞进他的屁股里！" id hostess_club_interior_d0e29d9f

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:46
translate chinese_simplified hostess_club_interior_20b5e089:
    ...
    player happy "即使我很想参加，你也会有麻烦的。" id hostess_club_interior_20b5e089
...
translate chinese_simplified hostess_club_interior_a4250fca:
    ...
    player neutral "小心他，他叫阿基拉。" id hostess_club_interior_a4250fca
...
translate chinese_simplified hostess_club_interior_234d945b:
    ...
    player "他会恶意接近她。。。" id hostess_club_interior_234d945b
...
translate chinese_simplified hostess_club_interior_6527820f:
    ...
    macumba "我想…我已经和他打交道了。" id hostess_club_interior_6527820f
...
translate chinese_simplified hostess_club_interior_6b238c4f:
    ...
    macumba "他没有钱，所以我不需要威胁他。" id hostess_club_interior_6b238c4f
...
translate chinese_simplified hostess_club_interior_d0d51087:
    ...
    macumba happy "我向你保证，这里没有人会把手放在她身上，这是麦肯巴的话。" id hostess_club_interior_d0d51087
...
translate chinese_simplified hostess_club_interior_330f74fb:
    ...
    player happy "你从我肩上摘下一颗豌豆，你甚至无法想象。。。" id hostess_club_interior_330f74fb
...
translate chinese_simplified hostess_club_interior_0e7ca8fc:
    ...
    macumba "为了我弟弟！" id hostess_club_interior_0e7ca8fc
...
translate chinese_simplified hostess_club_interior_a74ee73a:
    ...
    macumba neutral "他不会有任何问题的，他是一个常客，总是表现得很好，从来没有碰过任何女主人。" id hostess_club_interior_a74ee73a
...
translate chinese_simplified hostess_club_interior_ade985dd:
    ...
    player happy "所以我可能无缘无故地担心。" id hostess_club_interior_ade985dd
...
translate chinese_simplified hostess_club_interior_84d6ffed:
    ...
    macumba "把你所有的问题都交给我，我来处理。" id hostess_club_interior_84d6ffed
...
translate chinese_simplified hostess_club_interior_8a5433b5:
    ...
    macumba "想想你的训练！" id hostess_club_interior_8a5433b5
...
translate chinese_simplified hostess_club_interior_b85f9f11:
    ...
    # player "C'est promis!" id hostess_club_interior_b85f9f11
    player "我保证！" id hostess_club_interior_b85f9f11

# game/scripts/story/business district/hostess club/hostess_club_interior.rpy:61
translate chinese_simplified hostess_club_interior_36b5db1c:
    ...
    macumba happy "我得回去工作了，晚安，兄弟！" id hostess_club_interior_36b5db1c
